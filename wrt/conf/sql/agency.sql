WITH j (iata_id, agency, city, country, region, continent) AS (
  VALUES
    ...
    ('SAC', 'Sacramento Regional Transit District (SacRT)', 'Sacramento', 'United States', 'United States West', 'North America'),
    ...
    ('SFD', 'Transit Authority of River City (TARC)', 'Louisville', 'United States', 'United States South', 'North America'),
    ('BNA', 'Nashville Metropolitan Transit Authority (Nashville MTA)', 'Nashville', 'United States', 'United States South', 'North America'),
    ('MSP', 'Metro Transit (Minnesota)', 'Minneapolis / St. Paul', 'United States', 'United States Central', 'North America'),
    ...
    ('DEN', 'Regional Transportation District (RTD)', 'Denver', 'United States', 'United States West', 'North America'),
    ('PHX', 'Valley Metro Regional Public Transportation Authority (Valley Metro)', 'Phoenix', 'United States', 'United States West', 'North America'),
    ('SAT', 'VIA Metropolitan Transit Authority (VIA Metro)', 'San Antonio', 'United States', 'United States West', 'North America'),
    ('BIL', 'Billings Metropolitan Transit (MET)', 'Billings', 'United States', 'United States West', 'North America'),
    ('AUS', 'Capital Metropolitan Transportation Authority (CapMetro)', 'Austin', 'United States', 'United States West', 'North America'),
    ...
    ('YVR', 'TransLink', 'Vancouver', 'Canada', 'Canada West', 'North America'),
    ...
    ('YYJ', 'Victoria Regional Transit System', 'Victoria', 'Canada West', 'Canada', 'North America'),
    ('NLD', 'Openbaar Vervoer (OV)', 'Amsterdam', 'Netherlands', 'Europe West', 'Europe'),
    ('ARN', 'Storstockholms Lokaltrafik (SL)', 'Stockholm', 'Sweden', 'Europe West', 'Europe'),
    ('HEL', 'Helsinki Regional Transport Authority (HSL)', 'Helsinki', 'Finland', 'Europe West', 'Europe'),
    ...
    ('GDN', 'Zarządu Transportu Miejskiego w Gdańsku (ZKM)', 'Gdańsk', 'Poland', 'Europe Central', 'Europe'),
